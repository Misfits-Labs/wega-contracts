...
export declare namespace ERC721DummyOne {
...
export interface ERC721DummyOneInterface extends utils.Interface {
  functions: {
...
export interface ERC721DummyOne extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721DummyOneInterface;
  ...
  functions: {
    ...
    getNFT(
      tokenId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ERC721DummyOne.NFTStructOutput]>;
  ...
  getNFTs(overrides?: CallOverrides): Promise<ERC721DummyOne.NFTStructOutput[]>;
