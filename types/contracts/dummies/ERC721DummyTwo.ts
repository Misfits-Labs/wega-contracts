...
export declare namespace ERC721DummyTwo {
  export type NFTStruct = {
    nftAddress: PromiseOrValue<string>;
    tokenId: PromiseOrValue<BigNumberish>;
    gradientOne: PromiseOrValue<string>;
    gradientTwo: PromiseOrValue<string>;
  };

  export type NFTStructOutput = [string, BigNumber, string, string] & {
    nftAddress: string;
    tokenId: BigNumber;
    gradientOne: string;
    gradientTwo: string;
...
export interface ERC721DummyTwoInterface extends utils.Interface {
  functions: {
...
export interface ERC721DummyTwo extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721DummyTwoInterface;
  ...
  functions: {
    ...
    getNFT(
      tokenId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ERC721DummyTwo.NFTStructOutput]>;
  ...
  getNFTs(overrides?: CallOverrides): Promise<ERC721DummyTwo.NFTStructOutput[]>;
